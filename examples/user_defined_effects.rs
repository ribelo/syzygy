...
enum TodoEffect {
    ...
    /// Save to database
    Database { query: String, params: Vec<String> },
}
...
fn todo_update(
    ...
    match event {
        TodoEvent::AddTodo { text } => {
            ...
            // Then sync to server
            Command::batch([
                Command::event(TodoEvent::TodoAdded {
                    id,
                    text: text.clone(),
                }),
                Command::effect(TodoEffect::Log {
        ...
        TodoEvent::SaveTodos => Command::effect(TodoEffect::Database {
        ...
        TodoEvent::TodosSaved => Command::effect(TodoEffect::Log {
            level: LogLevel::Info,
        ...
        TodoEvent::TodoRemoved { id } => Command::effect(TodoEffect::Log {
            level: LogLevel::Info,
