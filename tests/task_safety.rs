#![allow(dead_code, clippy::clone_on_ref_ptr, unused_variables, unused_imports, clippy::let_and_return, clippy::format_in_format_args, clippy::cast_sign_loss)]
//! Task Safety Tests
//!
...
async fn test_tasks_cancelled_on_context_drop() {
    ...
    {
        let ctx: EffectContext<(), EmptyStorage> = EffectContext::new(None, EmptyStorage);
