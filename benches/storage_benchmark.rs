...
#[derive(Debug, Clone)]
struct Model1 { value: u64, data: [u8; 64] }

#[derive(Debug, Clone)]  
struct Model2 { value: u64, data: [u8; 64] }

#[derive(Debug, Clone)]
struct Model3 { value: u64, data: [u8; 64] }

#[derive(Debug, Clone)]
struct Model4 { value: u64, data: [u8; 64] }

#[derive(Debug, Clone)]
struct Model5 { value: u64, data: [u8; 64] }

#[derive(Debug, Clone)]
struct Model6 { value: u64, data: [u8; 64] }

#[derive(Debug, Clone)]
struct Model7 { value: u64, data: [u8; 64] }

#[derive(Debug, Clone)]
struct Model8 { value: u64, data: [u8; 64] }

#[derive(Debug, Clone)]
struct Model9 { value: u64, data: [u8; 64] }

#[derive(Debug, Clone)]
struct Model10 { value: u64, data: [u8; 64] }

#[derive(Debug, Clone)]
struct Model11 { value: u64, data: [u8; 64] }

#[derive(Debug, Clone)]
struct Model12 { value: u64, data: [u8; 64] }

#[derive(Debug, Clone)]
struct Model13 { value: u64, data: [u8; 64] }

#[derive(Debug, Clone)]
struct Model14 { value: u64, data: [u8; 64] }

#[derive(Debug, Clone)]
struct Model15 { value: u64, data: [u8; 64] }

#[derive(Debug, Clone)]
struct Model16 { value: u64, data: [u8; 64] }

impl Default for Model1 { fn default() -> Self { Self { value: 1, data: [1; 64] } } }
impl Default for Model2 { fn default() -> Self { Self { value: 2, data: [2; 64] } } }
impl Default for Model3 { fn default() -> Self { Self { value: 3, data: [3; 64] } } }
impl Default for Model4 { fn default() -> Self { Self { value: 4, data: [4; 64] } } }
impl Default for Model5 { fn default() -> Self { Self { value: 5, data: [5; 64] } } }
impl Default for Model6 { fn default() -> Self { Self { value: 6, data: [6; 64] } } }
impl Default for Model7 { fn default() -> Self { Self { value: 7, data: [7; 64] } } }
impl Default for Model8 { fn default() -> Self { Self { value: 8, data: [8; 64] } } }
impl Default for Model9 { fn default() -> Self { Self { value: 9, data: [9; 64] } } }
impl Default for Model10 { fn default() -> Self { Self { value: 10, data: [10; 64] } } }
impl Default for Model11 { fn default() -> Self { Self { value: 11, data: [11; 64] } } }
impl Default for Model12 { fn default() -> Self { Self { value: 12, data: [12; 64] } } }
impl Default for Model13 { fn default() -> Self { Self { value: 13, data: [13; 64] } } }
impl Default for Model14 { fn default() -> Self { Self { value: 14, data: [14; 64] } } }
impl Default for Model15 { fn default() -> Self { Self { value: 15, data: [15; 64] } } }
impl Default for Model16 { fn default() -> Self { Self { value: 16, data: [16; 64] } } }
...
type LargeChain = Storage<Model1, Storage<Model2, Storage<Model3, Storage<Model4, 
                  Storage<Model5, Storage<Model6, Storage<Model7, Storage<Model8, EmptyStorage>>>>>>>>;

type ExtraLargeChain = Storage<Model1, Storage<Model2, Storage<Model3, Storage<Model4, 
                       Storage<Model5, Storage<Model6, Storage<Model7, Storage<Model8,
                       Storage<Model9, Storage<Model10, Storage<Model11, Storage<Model12,
                       Storage<Model13, Storage<Model14, Storage<Model15, Storage<Model16, EmptyStorage>>>>>>>>>>>>>>>>;
...
fn bench_multi_model_extraction(c: &mut Criterion) {
    ...
    group.bench_function("chain_medium_extract_all", |b| {
        b.iter(|| {
            ...
            (black_box(m1.value), black_box(m2.value), black_box(m3.value), black_box(m4.value))
        })
    });
    ...
    group.bench_function("chain_large_extract_all", |b| {
        b.iter(|| {
            ...
            (
                black_box(m1.value), black_box(m2.value), black_box(m3.value), black_box(m4.value),
                black_box(m5.value), black_box(m6.value), black_box(m7.value), black_box(m8.value)
            )
        })
    });
...
fn bench_bulk_vs_individual(c: &mut Criterion) {
    ...
    group.bench_function("individual_three_get", |b| {
        b.iter(|| {
            ...
            let m2: &Model2 = black_box(&medium_chain).get();
            let m3: &Model3 = black_box(&medium_chain).get();
            (black_box(m1.value), black_box(m2.value), black_box(m3.value))
        })
    });
    ...
    group.bench_function("bulk_extract_eight", |b| {
        b.iter(|| {
            let (m1, m2, m3, m4, m5, m6, m7, m8): (&Model1, &Model2, &Model3, &Model4, &Model5, &Model6, &Model7, &Model8) = 
    ...
    group.bench_function("individual_sixteen_get", |b| {
        b.iter(|| {
            ...
            (
                black_box(m1.value), black_box(m2.value), black_box(m3.value), black_box(m4.value),
                black_box(m5.value), black_box(m6.value), black_box(m7.value), black_box(m8.value),
                black_box(m9.value), black_box(m10.value), black_box(m11.value), black_box(m12.value),
                black_box(m13.value), black_box(m14.value), black_box(m15.value), black_box(m16.value)
            )
        })
    });
    ...
    group.bench_function("bulk_extract_sixteen", |b| {
        b.iter(|| {
            let (m1, m2, m3, m4, m5, m6, m7, m8, m9, m10, m11, m12, m13, m14, m15, m16): (&Model1, &Model2, &Model3, &Model4, &Model5, &Model6, &Model7, &Model8, &Model9, &Model10, &Model11, &Model12, &Model13, &Model14, &Model15, &Model16) = 
